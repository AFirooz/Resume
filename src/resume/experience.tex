...
\cventry
    ...
    {}
    {
        \begin{cvitemsfree}
            ...
            %
            \item{Applied data reduction techniques to \textbf{over 77K small molecule chemical descriptors} for unsupervised clustering. Trained an XGBoost model with optimized hyperparameters for retention time prediction, achieving RMSE \approx \space 8.}
            %
